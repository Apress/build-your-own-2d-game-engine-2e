...
class MyGame extends engine.Scene {
    ...
    init() {
        ...
        this.mLMinion.getRenderable().addLight(this.mGlobalLightSet.getLightAt(0));   // LMinion light
        ...
        this.mRMinion.getRenderable().addLight(this.mGlobalLightSet.getLightAt(0));   // RMinion light
    ...
    update() {
        let msg = "Selected Light=" + this.mLgtIndex + " ";
